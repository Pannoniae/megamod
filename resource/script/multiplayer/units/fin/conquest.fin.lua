	...
	{Repeat = 0, --infinite
		Units = {
			...
			-- Infantry
				...
				--{priority = 1.0, type = {"Infantry", "Squad", "Command",}, unit = "squad_officer_con(fin)"},

				--T1
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_civil_guard_early_con(fin)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_reserves_mid_con(fin)"},
				...
				{priority = 0.5, type = {"Infantry", "Squad",}, unit = "squad_eng_flame_con(fin)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_elite_rifle_mid_con(fin)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_elite_rifle_late_con(fin)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad", "AT",}, unit = "squad_jag_at_late_con(fin)"},

				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_border_jag_mid_con(fin)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_border_jag_late_con(fin)"},
				{priority = 1.0, type = {"Infantry", "Squad", "AT",}, unit = "squad_border_jag_at_late_con(fin)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_sissi_mid_con(fin)"},
				
				--T4+
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_vet_jag_mid_con(fin)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_vet_jag_late_con(fin)"},
				...
				{priority = 0.5, type = {"Infantry", "Team",}, unit = "single_engineer(fin)"},
				{priority = 1.5, type = {"Infantry", "Team",}, unit = "single_flamer(fin)"},
				{priority = 0.1, type = {"Infantry", "Squad",}, unit = "squad_heavy_engineer_mid_con(fin)"},
				{priority = 1.5, type = {"Infantry", "Team",}, unit = "single_sniper(fin)"},
				{priority = 0.1, type = {"Infantry", "Team",}, unit = "white_death_con(fin)"},
			...
			-- Cannons
				...
				{priority = 1.5, type = {"Cannon", "AA", "AT",}, unit = "75mm_itk37"},
				--Anti Tank
				...
				--Artillery
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "105mm_k13"},
				{priority = 0.5, type = {"Cannon", "Artillery",}, unit = "105mm_h33"},
				{priority = 0.5, type = {"Cannon", "Artillery",}, unit = "105mm_k34"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "107mm_k10"},
				{priority = 0.5, type = {"Cannon", "Artillery",}, unit = "120mm_k78_31"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "122mm_m1910_fin"},
				{priority = 0.5, type = {"Cannon", "Artillery",}, unit = "150mm_h40"},
				{priority = 1.5, type = {"Cannon", "Artillery",}, unit = "155mm_h17"},
				{priority = 0.1, type = {"Cannon", "Artillery",}, unit = "203mm_h17"},
				--Rocket Artillery
				{priority = 0.1, type = {"Cannon", "Artillery",}, unit = "150mm_rkh41"},
				--]]
			...
			-- Tanks
				...
				{priority = 0.5, type = {"Tank", "Medium",}, unit = "t28_38_fin"},
				{priority = 1.5, type = {"Tank", "Medium",}, unit = "t3476_41_fin"},
				{priority = 0.5, type = {"Tank", "Medium",}, unit = "panzer4j_fin"},
