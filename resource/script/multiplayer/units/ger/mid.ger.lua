	...
	{Repeat = 0,  --infinite
		Units = {
			...
			-- Doctrine Point Units
				...
				--  Extra Doctrine
					--[[					
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier1", "Tank", "AA",}, unit = "doctrine_flakpanzer1a"},
					{priority = 1.0, type = {"Class1", "Doctrine", "Tier1", "Tank", "Light",}, unit = "doctrine_panzer2j"},
					
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier2", "Armored", "AT",}, unit = "doctrine_sdkfz251c_9"},
					{priority = 1.0, type = {"Class3", "Doctrine", "Tier2", "Cannon", "AT",}, unit = "doctrine_76mm_pak36r"},
					{priority = 1.0, type = {"Class1", "Doctrine", "Tier2", "Tank", "AT", "Light",}, unit = "doctrine_marder139"},
					
					{priority = 1.0, type = {"Class1", "Doctrine", "Tier3", "Tank", "Medium", "AT",}, unit = "doctrine_dicker_max"},
					{priority = 1.0, type = {"Class3", "Doctrine", "Tier3", "Tank", "Medium", "Artillery",}, unit = "doctrine_geschuetzwagen_ivb"},
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier3", "Tank", "Light", "Artillery",}, unit = "doctrine_b1sf"},
					--]]
			--]====]
		}
	}
